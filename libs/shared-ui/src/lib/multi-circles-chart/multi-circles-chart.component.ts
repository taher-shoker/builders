...
export class MultiCirclesChartComponent implements OnChanges, OnDestroy {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (
      changes['chartData2'] &&
      changes['chartData2'].currentValue.length !== 0
    ) {
  ...
  //     data.push({
  //       title: d.title,
  //       spendPercentage: d.value1,
  //       accrualPercentage: d.value2,
  //       full: this.maxWidth,
  ...
  //     tooltipText: 'Accural: {accrualPercentage} SAR',
  //     cornerRadius: 0,
  //     templateField: 'columnSettings',
  //   });
  ...
  //     tooltipText: 'Spending: {spendPercentage} SAR'
  //   });
