        ...
        <div id="middle-content">
          <div id="middle-left-content">
            <div id="learning-materials" class="rounded shadow">
              ...
              <a
                href="https://nx.dev/tutorials/3-angular-monorepo/1a-introduction/1-welcome?utm_source=nx-project"
                target="_blank"
                rel="noreferrer"
                class="list-item-link"
              >
...
nx run-many -p nokiaChat -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project nokiaChat</pre>
          </details>
